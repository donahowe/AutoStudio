...
parser.add_argument("--sd_path", default='/pretrained_models/diffusion_1.5', type=str, help="Path to Stable Diffusion Folder")
parser.add_argument("--vae_path", default='/pretrained_models/vae_ft_mse', type=str, help="Path to VAE Folder")
parser.add_argument("--repeats", default=20, type=int, help="Number of samples for each prompt")
parser.add_argument("--seed_offset", default=1, type=int, help="Offset to the seed (seed starts from this number)")
parser.add_argument("--sd_version", default='1.5plus', type=str, help="Base model version. Pick from [1.5, 1.5plus]") # 1.5, 1.5plus is recommended
...
for dialogue in instructions: 
    ...
    # '0' stand for place holder image. If you need a human-specified reference, please read the image and import it into the corresponding ID, like {,..., '1': img1}
